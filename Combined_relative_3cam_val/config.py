"""
Combined-relative-3cam-val (mixed human + robot) ACT constants and helpers.

Same layout as Combined_relative_3cam; training adds demo-level validation.
...
def build_run_metadata(
    *,
    ...
    return {
        "variant": "combined-relative-3cam-val",
