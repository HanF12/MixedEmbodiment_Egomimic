...
but drives Combined_relative_3cam_gripweight.MixedDETRVAE with:
  - embodiment = robot
...
DEFAULT_CHECKPOINT = "combined_act_best_3cam.pth"
DEFAULT_ROBOT_NORM = "normalization_stats_robot_3cam.npz"
