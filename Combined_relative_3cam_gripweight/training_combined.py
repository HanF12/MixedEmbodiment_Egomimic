...
from Combined_relative_3cam_gripweight.config import (  # noqa: E402
    DEFAULT_BATCH_SIZE,
...
from Combined_relative_3cam_gripweight.core import build, kl_divergence  # noqa: E402
from Combined_relative_3cam_gripweight.data_synchronization import (  # noqa: E402
    synchronize_human_hands,
    synchronize_robot_bimanual,
)
from Combined_relative_3cam_gripweight.dataloader_human import HumanEpisodeDataset, collate_homogeneous  # noqa: E402
from Combined_relative_3cam_gripweight.dataloader_robot import RobotEpisodeDataset  # noqa: E402
from Combined_relative_3cam_gripweight.dataloader_utils import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="Combined-relative-3cam mixed human+robot ACT training (relative pose actions)"
    )
    p.add_argument(
        "--robot_data_root",
        type=str,
...
def masked_recon_loss(
    ...
    *,
    ...
    """Mean over valid scalar elements; optional per-dim weights (e.g. gripper boost)."""
    if kind == "mse":
    ...
    *,
    ...
    if has_joint:
        ...
        joint_loss = masked_recon_loss(
            joint_pred, joint_actions, is_pad, kind=recon_kind, dim_weights=joint_dim_w
        )
...
def main() -> None:
    ...
    if cli.dry_run:
        print("--- Combined-relative-3cam dry run ---")
        if human_loader is not None:
