...
but drives Combined_relative_xyz_3cam.MixedDETRVAE with:
  - embodiment = robot
  - proprio = joint_state [14]  (robot_input_proj)
  - camera slots [bird, left_wrist, right_wrist] (3-cam; no front)
  - shared pose head is xyz-only (6D); control from joint_action_head only
...
DEFAULT_CHECKPOINT = "combined_act_best_3cam_xyz.pth"
DEFAULT_ROBOT_NORM = "normalization_stats_robot_3cam_xyz.npz"
DEFAULT_HUMAN_NORM = "normalization_stats_human_3cam_xyz.npz"
