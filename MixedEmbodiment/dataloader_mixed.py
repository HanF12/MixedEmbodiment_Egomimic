...
from MixedEmbodiment.data_synchronization import side_to_slot
    ...
    def __init__(
        ...
        *,
        ...
        for sync_csv in sync_csvs:
            ...
            if len(df) < 2:
                print(f"WARNING: skip mixed {rec_id} - too few rows after filters")
                continue
            ...
            hand_pose = hand_npz["pose"]
            eef_pose = eef_npz["pose"]
