#!/usr/bin/env python
"""
MixedEmbodiment ACT inference for checkpoints with *no human proprio*
...
parser = argparse.ArgumentParser(
    description=(
        "MixedEmbodiment ACT inference for no-human-proprio checkpoints "
...
parser.add_argument("--max_gripper_speed", type=float, default=999)
...
rospy.init_node("mixed_embodiment_act_inference_no_human_proprio", anonymous=True)
