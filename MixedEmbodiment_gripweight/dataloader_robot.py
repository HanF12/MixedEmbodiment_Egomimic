...
from MixedEmbodiment_gripweight.data_synchronization import xyz_gripper_valid_mask
...
class RobotEpisodeDataset(Dataset):
    ...
    def __init__(
        ...
        *,
        ...
        if self.num_demos == 0:
            raise FileNotFoundError("No complete robot demos found for MixedEmbodiment_gripweight.")
