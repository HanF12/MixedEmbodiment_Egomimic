...
Example:
  python -m MixedEmbodiment_gripweight.build_sync \\
...
from MixedEmbodiment_gripweight.config import HUMAN_POSE_RELDIR, ROBOT_EEF_RELDIR
...
from MixedEmbodiment_gripweight.data_synchronization import (
    EMBODIMENT_PRESETS,
    Side,
