...
# Fallback when --mixed_lambda is explicit or mixed inactive. Training default is
# auto: mixed_batches / steps_per_epoch (see resolve_mixed_lambda).
...
ROBOT_NPZ_GRIPPER_BINARIZE_THRESHOLD = 0.5
ROBOT_NPY_GRIPPER_BINARIZE_THRESHOLD = 0.5
# Back-compat aliases
