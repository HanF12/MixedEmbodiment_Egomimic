"""
Combined-relative (mixed human + robot) ACT constants and helpers.

Same layout as Combined, but shared pose actions are *relative* to the first
observation in the action chunk (not absolute world/common-frame poses).
...
def build_run_metadata(
    *,
    ...
    return {
        "variant": "combined-relative-egomimic-style",
        ...
        "gripper_semantics": (
            ...
            "robot gripper retained as-recorded; relative pose deltas include gripper dims"
        ),
