"""Robot episode dataset for MixedEmbodiment_dual ACT (3 cameras, 8D EEF pose + 14D joints)."""
...
from MixedEmbodiment_dual.data_synchronization import xyz_gripper_valid_mask
...
class RobotEpisodeDataset(Dataset):
    ...
    def __init__(
        ...
        *,
        ...
        print("Loading robot MixedEmbodiment_dual demos...")
        ...
        if self.num_demos == 0:
            raise FileNotFoundError("No complete robot demos found for MixedEmbodiment_dual.")
