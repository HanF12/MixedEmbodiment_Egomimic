...
Example:
  python -m MixedEmbodiment_dual.build_sync \\
...
# Allow running as `python MixedEmbodiment_dual/build_sync.py` from repo root.
_REPO_ROOT = Path(__file__).resolve().parents[1]
if str(_REPO_ROOT) not in sys.path:
    sys.path.insert(0, str(_REPO_ROOT))

from MixedEmbodiment_dual.config import HUMAN_POSE_RELDIR, ROBOT_EEF_RELDIR
...
from MixedEmbodiment_dual.data_synchronization import (
    EMBODIMENT_PRESETS,
    Side,
