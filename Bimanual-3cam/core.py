"""
Bimanual-3cam 14D DETR-VAE model built on the shared ALOHA backbone/transformer code.
"""
...
from config import MODEL_CAMERA_NAMES, STATE_DIM, validate_camera_names, validate_state_dim  # noqa: E402
