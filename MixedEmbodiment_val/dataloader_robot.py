"""Robot episode dataset for MixedEmbodiment_val ACT (3 cameras, 8D EEF pose + 14D joints)."""
...
from MixedEmbodiment_val.data_synchronization import xyz_gripper_valid_mask
from MixedEmbodiment_val.dataloader_utils import (
...
class RobotEpisodeDataset(Dataset):
    ...
    def __init__(
        ...
        *,
        ...
        print("Loading robot MixedEmbodiment_val demos...")
        ...
        if self.num_demos == 0:
            raise FileNotFoundError("No complete robot demos found for MixedEmbodiment_val.")
