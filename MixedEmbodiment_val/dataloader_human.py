"""Human hand episode dataset for MixedEmbodiment_val ACT (bird + 8D hand pose)."""
...
class HumanEpisodeDataset(Dataset):
    ...
    def __init__(
        ...
        *,
        ...
        print("Loading human MixedEmbodiment_val demos...")
        ...
        if self.num_demos == 0:
            raise FileNotFoundError("No complete human demos found for MixedEmbodiment_val.")
...
def collate_homogeneous(batch: list[dict]) -> dict:
    """Collate a batch that is all-robot, all-human, or all-mixed."""
