"""
Mixed human + robot ACT training with relative xyz-only pose actions.
...
- Joint actions remain absolute; gripper joint NPYs treated as continuous
...
from Combined_relative_xyz.config import (  # noqa: E402
    DEFAULT_BATCH_SIZE,
    DEFAULT_HAND_LAMBDA,
...
from Combined_relative_xyz.core import build, kl_divergence  # noqa: E402
from Combined_relative_xyz.data_synchronization import (  # noqa: E402
    synchronize_human_hands,
    synchronize_robot_bimanual,
)
from Combined_relative_xyz.dataloader_human import HumanEpisodeDataset, collate_homogeneous  # noqa: E402
from Combined_relative_xyz.dataloader_robot import RobotEpisodeDataset  # noqa: E402
from Combined_relative_xyz.dataloader_utils import (  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="Combined-relative-xyz mixed human+robot ACT training (relative xyz-only pose)"
    )
    p.add_argument(
        "--robot_data_root",
        type=str,
...
def main() -> None:
    ...
    if cli.dry_run:
        print("--- Combined-relative-xyz dry run ---")
        if human_loader is not None:
