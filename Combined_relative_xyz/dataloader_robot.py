"""Robot episode dataset for Combined-relative ACT (4 cameras, 6D xyz EEF pose + 14D joints)."""
...
from Combined_relative_xyz.config import (
    DEFAULT_NUM_QUERIES,
    EMBODIMENT_ROBOT,
    POSE_DIM,
    ROBOT_JOINT_DIM,
...
from Combined_relative_xyz.data_synchronization import xyz_only_valid_mask
from Combined_relative_xyz.dataloader_utils import (
...
class RobotEpisodeDataset(Dataset):
    ...
    Returns dict (common batch schema):
      ...
      pose_state [6], pose_actions [K,6]  (xyz only; rot+grip dropped),
    ...
    def __getitem__(self, idx: int) -> dict:
        ...
        pose_raw = self.eef_pose_data[sample_idx]  # [6] absolute xyz, chunk anchor
