...
Pose action head predicts relative xyz deltas vs the chunk's first observation
(see Combined_relative_xyz dataloaders). Joint head still predicts absolute joints
(with continuous gripper channels).
...
Shared:
  ...
  - pose_action_head: H -> 6  (human primary + robot aux; xyz only)
