"""Human hand episode dataset for Combined-relative ACT (2 cameras + 6D xyz hand pose)."""
...
class HumanEpisodeDataset(Dataset):
    ...
    Hand pose from NPZ key `pose` with shape [T, 2, 10] -> xyz flattened [6]
    (rot6d and open/gripper dropped).
    ...
    def __getitem__(self, idx: int) -> dict:
        ...
        pose_raw = self.pose_data[sample_idx]  # [6] absolute xyz, chunk anchor
